...
const BOT_NAME = process.env.BOT_NAME || "𝗠𝗔𝗡𝗜𝗜-𝟬𝟱-𝗠𝗗";
const OWNER_NAME = process.env.OWNER_NAME || "𝗠𝗔𝗡𝗜𝗜-𝟬𝟱 🚩💀";
...
const AUTO_STATUS_MSG = process.env.AUTO_STATUS_MSG || "YOUR STATUS HAS BEEN SEEN BY MANII 05 🫶🏻";
const DEV = process.env.DEV || '𝗠𝗔𝗡𝗜𝗜-𝟬𝟱 🚩💀';
            ...
            case 'menu1':
                ...
                await conn.sendMessage(from, {
                    ...
                    forwardedNewsletterMessageInfo: {
                        ...
                        externalAdReply: {
                            title: "📃 𝗠𝗔𝗡𝗜𝗜-𝟬𝟱-𝗠𝗗 Command Menu",
